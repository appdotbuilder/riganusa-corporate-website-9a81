      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            <h3 className="text-2xl font-bold font-serif text-blue-400 mb-4">
              Riganusa
            </h3>
            <p className="text-gray-300 mb-4 leading-relaxed">
              Leading provider of premium Crude Palm Oil solutions, committed to quality, 
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="/about/history" className="text-gray-300 hover:text-blue-400 transition-colors">
                  About Us
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <span className="text-gray-300">CPO Trading</span>
              </li>
              <li>
                <span className="text-gray-300">Quality Assurance</span>
              </li>
              <li>
                <span className="text-gray-300">Supply Chain Management</span>
              </li>
              <li>
                <span className="text-gray-300">Logistics Solutions</span>
              </li>
              <li>
                <span className="text-gray-300">Consultation Services</span>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center">
                ...
                <span className="text-gray-300 text-sm">info@riganusa.com</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm mb-4 md:mb-0">
              © {new Date().getFullYear()} Riganusa. All rights reserved.
            </p>
